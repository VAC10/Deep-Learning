...
encoded = MaxPooling2D((2,2), padding='same')(x)# darboğazımız bu kısım

#DECODE Modeli(kod çozucu kısım) 
...
autoencoder.fit(x_train_noisy, x_train,
                epochs=10,
                batch_size=128,# verimiz uyuk oldugundan batch_size=128 aldık
                shuffle=True,
